...
var useInterval = function useInterval2(fn) {
  ...
  var clear = React.useCallback(function() {
    return clearInterval(timeout2.current);
  }, [timeout2.current]);
  React.useEffect(function() {
  ...
  React.useEffect(function() {
    ...
    if (when) {
      timeout2.current = setInterval(callback, delay);
      return clear;
    } else {
      clear();
    }
...
var ChevronLeftIcon = React12.memo(React12.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var ChevronUpIcon = React15.memo(React15.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var GalleriaItem = React16.memo(React16.forwardRef(function(props, ref) {
  var mergeProps2 = useMergeProps();
  var indicatorContent = React16.useRef(null);
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showItemNavigators) {
      ...
      var previousItemIconProps = mergeProps2({
        className: cx("previousItemIcon")
      }, getPTOptions("previousItemIcon"));
      var icon = props.itemPrevIcon || React16.createElement(ChevronLeftIcon, previousItemIconProps);
      var itemPrevIcon = IconUtils.getJSXIcon(icon, _objectSpread$2({}, previousItemIconProps), {
        props
      });
      var previousItemButtonProps = mergeProps2({
        type: "button",
      ...
      return React16.createElement("button", previousItemButtonProps, itemPrevIcon, React16.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showItemNavigators) {
      ...
      var nextItemIconProps = mergeProps2({
        className: cx("nextItemIcon")
      }, getPTOptions("nextItemIcon"));
      var icon = props.itemNextIcon || React16.createElement(ChevronRightIcon, nextItemIconProps);
      var itemNextIcon = IconUtils.getJSXIcon(icon, _objectSpread$2({}, nextItemIconProps), {
        props
      });
      var nextItemButtonProps = mergeProps2({
        type: "button",
      ...
      return React16.createElement("button", nextItemButtonProps, itemNextIcon, React16.createElement(Ripple, null));
    }
    return null;
  };
  var createCaption = function createCaption2() {
    var captionProps = mergeProps2({
      className: cx("caption")
    }, getPTOptions("caption"));
    if (props.caption) {
      var _content = props.caption(props.value[props.activeItemIndex]);
      return React16.createElement("div", captionProps, _content);
    }
    return null;
  };
  var createIndicator = function createIndicator2(index) {
    ...
    if (!indicator2) {
      indicator2 = React16.createElement("button", {
        tabIndex: props.activeIndex === index ? "0" : "-1",
        type: "button",
        className: "p-link"
      }, React16.createElement(Ripple, null));
    }
    return React16.createElement("li", indicatorProps, indicator2);
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React16.createElement("ul", _extends8({
  ...
  var itemWrapperProps = mergeProps2({
    ref,
    className: cx("itemWrapper")
  }, getPTOptions("itemWrapper"));
  var itemContainerProps = mergeProps2({
  ...
  return React16.createElement("div", itemWrapperProps, React16.createElement("div", itemContainerProps, backwardNavigator, React16.createElement("div", itemProps, content), forwardNavigator, caption), indicators);
}));
...
var GalleriaThumbnailItem = React16.memo(function(props) {
  var mergeProps2 = useMergeProps();
  var ptm = props.ptm, cx = props.cx;
  var getPTOptions = function getPTOptions2(key, options) {
  ...
  var onTabKey = function onTabKey2() {
    var indicators = _toConsumableArray3(DomHandler.find(props.itemsContainerRef.current, '[data-pc-section="thumbnailitem"]'));
  ...
  var thumbnailItemProps = mergeProps2({
  ...
  var thumbnailItemContentProps = mergeProps2({
  ...
  return React16.createElement("div", thumbnailItemProps, React16.createElement("div", thumbnailItemContentProps, content));
});
var GalleriaThumbnails = React16.memo(React16.forwardRef(function(props, ref) {
  var mergeProps2 = useMergeProps();
  var _React$useState = React16.useState(props.numVisible), _React$useState2 = _slicedToArray4(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React16.useState(0), _React$useState4 = _slicedToArray4(_React$useState3, 2), totalShiftedItemsState = _React$useState4[0], setTotalShiftedItemsState = _React$useState4[1];
  var itemsContainerRef = React16.useRef(null);
  var startPos = React16.useRef(null);
  var attributeSelector = React16.useRef("");
  var thumbnailsStyle = React16.useRef(null);
  var responsiveOptions = React16.useRef(null);
  ...
  var createItems = function createItems2() {
    return props.value.map(function(item, index) {
      ...
      return React16.createElement(GalleriaThumbnailItem, {
        key: index,
        index,
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showThumbnailNavigators) {
      ...
      var previousThumbnailIconProps = mergeProps2({
        className: cx("previousThumbnailIcon")
      }, getPTOptions("previousThumbnailIcon"));
      var icon = props.isVertical ? props.prevThumbnailIcon || React16.createElement(ChevronUpIcon, previousThumbnailIconProps) : props.prevThumbnailIcon || React16.createElement(ChevronLeftIcon, previousThumbnailIconProps);
      var prevThumbnailIcon = IconUtils.getJSXIcon(icon, _objectSpread$1({}, previousThumbnailIconProps), {
        props
      });
      var previousThumbnailButtonProps = mergeProps2({
      ...
      return React16.createElement("button", previousThumbnailButtonProps, prevThumbnailIcon, React16.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showThumbnailNavigators) {
      ...
      var nextThumbnailIconProps = mergeProps2({
        className: cx("nextThumbnailIcon")
      }, getPTOptions("nextThumbnailIcon"));
      var icon = props.isVertical ? props.nextThumbnailIcon || React16.createElement(ChevronDownIcon, nextThumbnailIconProps) : props.nextThumbnailIcon || React16.createElement(ChevronRightIcon, nextThumbnailIconProps);
      var nextThumbnailIcon = IconUtils.getJSXIcon(icon, _objectSpread$1({}, nextThumbnailIconProps), {
        props
      });
      var nextThumbnailButtonProps = mergeProps2({
      ...
      return React16.createElement("button", nextThumbnailButtonProps, nextThumbnailIcon, React16.createElement(Ripple, null));
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React16.createElement("div", thumbnailContainerProps, backwardNavigator, React16.createElement("div", thumbnailItemsContainerProps, React16.createElement("div", thumbnailItemsProps, items)), forwardNavigator);
  };
  var content = createContent();
  var thumbnailWrapperProps = mergeProps2({
    className: cx("thumbnailWrapper")
  }, getPTOptions("thumbnailWrapper"));
  return React16.createElement("div", thumbnailWrapperProps, content);
}));
...
var Galleria = React16.memo(React16.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React16.useContext(PrimeReactContext);
  var props = GalleriaBase.getProps(inProps, context);
  var _React$useState = React16.useState(false), _React$useState2 = _slicedToArray4(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React16.useState(props.numVisible), _React$useState4 = _slicedToArray4(_React$useState3, 2), numVisibleState = _React$useState4[0], setNumVisibleState = _React$useState4[1];
  var _React$useState5 = React16.useState(false), _React$useState6 = _slicedToArray4(_React$useState5, 2), slideShowActiveState = _React$useState6[0], setSlideShowActiveState = _React$useState6[1];
  var _React$useState7 = React16.useState(props.activeIndex), _React$useState8 = _slicedToArray4(_React$useState7, 2), activeIndexState = _React$useState8[0], setActiveIndexState = _React$useState8[1];
  var elementRef = React16.useRef(null);
  var previewContentRef = React16.useRef(null);
  ...
  var createHeader = function createHeader2() {
    ...
    if (props.header) {
      return React16.createElement("div", headerProps, props.header);
    }
    return null;
  };
  var createFooter = function createFooter2() {
    ...
    if (props.footer) {
      return React16.createElement("div", footerProps, props.footer);
    }
    return null;
  };
  var createElement9 = function createElement10() {
    ...
    var icon = props.closeIcon || React16.createElement(TimesIcon, closeIconProps);
    ...
    var closeButton = props.fullScreen && React16.createElement("button", closeButtonProps, closeIcon, React16.createElement(Ripple, null));
    ...
    var element = React16.createElement("div", rootProps, closeButton, header, React16.createElement("div", contentProps, React16.createElement(GalleriaItem, {
      hostName: "Galleria",
      ...
      ptm,
      cx
    }), props.showThumbnails && React16.createElement(GalleriaThumbnails, {
      hostName: "Galleria",
      value: props.value,
      containerId: id,
      activeItemIndex,
  ...
  var createGalleria = function createGalleria2() {
    ...
    if (props.fullScreen) {
      ...
      var galleriaWrapper = React16.createElement("div", _extends8({
        ref: maskRef
      }, maskProps), React16.createElement(CSSTransition2, _extends8({
        nodeRef: elementRef
